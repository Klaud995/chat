...
import 'package:chat/features/chat/widgets/message_reply_preview.dart';
...
class _BottomChatFieldState extends ConsumerState<BottomChatField> {
  ...
  void openAudio() async {
    ...
    if (status != PermissionStatus.granted) {
      throw RecordingPermissionException('Права на микрофон не выданы!');
    }
